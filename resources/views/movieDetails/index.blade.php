            ...
            <div class="md:ml-24">
                ...
                <p class="text-gray-300 mt-8">
                    ...
                    @foreach($movieDetails['directors'] as $director)
                        <b><a class="link" href="{{ route('actors.showActor', $director['id']) }}">{{ $director['name'] }}</a></b>
                        @if (!$loop->last)
                            ,
                        @endif
                    @endforeach
                ...
                <div class="mt-12 flex">
                    ...
                    <div class="flex flex-col ml-36">
                        <ul>
                            ...
                            <li class="mb-4">
                                <button
                                    class="watch flex items-center rounded font-semibold w-48 h-12 justify-center transition ease-in-out duration-150">
                            ...
                            <li class="mb-4">
                                <button
                                    class="like flex items-center rounded font-semibold w-48 h-12 justify-center transition ease-in-out duration-150">
                            ...
                            <li class="mb-4">
                                <button
                                    class="watchlist flex items-center rounded font-semibold w-48 h-12 justify-center transition ease-in-out duration-150">
                            ...
                            <li class="mb-4">
                                <button
                                    class="review flex items-center rounded font-semibold w-48 h-12 justify-center transition ease-in-out duration-150">
                            ...
                            <li class="mb-4">
                                <button
                                    class="rate flex items-center rounded font-semibold w-48 h-12 justify-center transition ease-in-out duration-150">
                            ...
                            <li class="mb-4">
                                <button
                                    ...
                                    <span class="ml-2">
                                        <a class="movieLog" href="{{ route('login') }}">Sign in to log, rate or review</a>
                                    </span>
                                </button>
                            </li>
                            @endguest
    ...
    <div id="modal" class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto">
        <div class="container py-16 mx-auto lg:px-32 rounded-lg overflow-y-auto bg-gray-900/50">
            <div class="flex justify-end pr-4 pt-2">
                <button id="closeBtn" class="closeBtn text-3xl leading-none">
